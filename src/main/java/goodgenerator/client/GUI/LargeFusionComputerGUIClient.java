...
public class LargeFusionComputerGUIClient extends GT_GUIContainer_MultiMachineEM {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (this.mContainer.mDisplayErrorCode == 0) {
            fontRendererObj.drawString(StatCollector.translateToLocal("gui.LargeFusion.0") + " " + this.mContainer.mStorage + " EU", 7, 40, 16448255);
            fontRendererObj.drawString(StatCollector.translateToLocal("gui.LargeFusion.1") + " " + this.mContainer.mEnergy + " EU", 7, 48, 16448255);
        }
    }
